...
class Panda:
  ...
  FLAG_BYD_LONG_CONTROL = 1
  FLAG_BYD_REVERSE_ACC_CAN = 2
  FLAG_BYD_TORQUE_WITH_FACTOR = 4
  FLAG_BYD_LOW_TORQUE = 8
  FLAG_BYD_TORQUE_CONTROL_ALT = 16
  FLAG_BYD_ANGLE_CONTROL = 32
  FLAG_BYD_ANGLE_CONTROL_ALT = 64
  FLAG_BYD_FORWARD_TEST = 128
  FLAG_BYD_FORCE_TORQUE_FIX = 256
  FLAG_BYD_TORQUE_WITH_FACTOR_ALT = 512
  FLAG_BYD_TORQUE_WITH_DRIVER = 1024
  FLAG_BYD_NG_EPB = 2048
  FLAG_BYD_REVERSE_BSM_CAN = 4096
  FLAG_BYD_TORQUE_REMATCHING_1 = 8192
  FLAG_BYD_TORQUE_REMATCHING_2 = 16384
  FLAG_BYD_TORQUE_REMATCHING_4 = 32768
