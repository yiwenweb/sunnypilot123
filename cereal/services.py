...
class Service:
  def __init__(self, port, should_log: bool, frequency: float, decimation: Optional[int] = None):
    self.port = port
...
_services: dict[str, tuple] = {
  ...
  "onroadEvents": (True, 1., 1), # re-ordered
  ...
  #custom
  "externalCameraState": (True, 20., 20),
  "externalEncodeIdx": (False, 20., 1),
  "externalEncodeData": (False, 20.),
  "livestreamExternalEncodeIdx": (False, 20.),
  "livestreamExternalEncodeData": (False, 20.),
  "qExternalEncodeIdx": (False, 20.),
  "qExternalEncodeData": (False, 20.),
}
