...
def driverview(started: bool, params: Params, CP: car.CarParams) -> bool:
  return started or params.get_bool("IsDriverViewEnabled") or params.get_bool("IsExternalViewEnabled")
...
def logging(started, params, CP: car.CarParams) -> bool:
  run = ((not CP.notCar) and not params.get_bool("DisableLogging")) and params.get_bool("EnableLogging")
  return started and run

def logging_with_bridge(started, params, CP: car.CarParams) -> bool:
  run = ((not CP.notCar) and not params.get_bool("DisableLogging")) and params.get_bool("EnableLogging") and not os.path.exists(os.path.join(BASEDIR, 'prebuilt'))
  return started and run
