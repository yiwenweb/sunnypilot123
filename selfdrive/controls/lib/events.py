...
def torque_nn_load_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int) -> Alert:
  ...
  if model_name in ("", "mock"):
    return Alert(
     _( "NN Lateral Controller Not Loaded"),
      _('⚙️ -> "sunnypilot" for more details'),
    ...
    return Alert(
      _("NN Lateral Controller Loaded"),
      alert_text_2,
...
def out_of_space_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int) -> Alert:
  ...
  return NormalPermanentAlert(_("Out of Storage"), f"{full_perc}% full")
...
def high_cpu_usage_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int) -> Alert:
  ...
  return NormalPermanentAlert(_("High CPU Usage"), f"{x}% used")
...
EVENTS: dict[int, dict[str, Alert | AlertCallbackType]] = {
  ...
  EventName.carUnrecognized: {
    ET.PERMANENT: NormalPermanentAlert(_("Dashcam Mode"),
                                       _('⚙️ -> "Vehicle" to select your car'),
                                       priority=Priority.LOWEST),
  },
  ...
  EventName.preKeepHandsOnWheel: {
    ET.WARNING: Alert(
      _("No hands on steering wheel detected"),
      "",
      AlertStatus.userPrompt, AlertSize.small,
  ...
  EventName.promptKeepHandsOnWheel: {
    ET.WARNING: Alert(
      _("HANDS OFF STEERING WHEEL"),
      _("Place hands on steering wheel"),
      AlertStatus.critical, AlertSize.mid,
      Priority.MID, VisualAlert.steerRequired, AudibleAlert.promptDistracted, .1),
  },

  EventName.keepHandsOnWheel: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert(_("Driver kept hands off sterring wheel")),
  },
  ...
  EventName.laneChangeRoadEdge: {
    ET.WARNING: Alert(
      _("Lane Change Unavailable: Road Edge"),
      "",
      AlertStatus.userPrompt, AlertSize.small,
      Priority.LOW, VisualAlert.none, AudibleAlert.prompt, .1),
  },
  ...
  EventName.manualSteeringRequired: {
    ET.WARNING: Alert(
      _("Automatic Lane Centering is OFF"),
  ...
  EventName.manualLongitudinalRequired: {
    ET.WARNING: Alert(
      _("Smart/Adaptive Cruise Control is OFF"),
  ...
  EventName.cruiseEngageBlocked: {
    ET.WARNING: Alert(
      ...
      _("Pedal Pressed During Cruise Engage"),
      AlertStatus.normal, AlertSize.mid,
  ...
  EventName.locationdTemporaryError: {
    ET.NO_ENTRY: NoEntryAlert(_("locationd Temporary Error")),
    ET.SOFT_DISABLE: soft_disable_alert(_("locationd Temporary Error")),
  },

  EventName.locationdPermanentError: {
    ET.NO_ENTRY: NoEntryAlert(_("locationd Permanent Error")),
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert(_("locationd Permanent Error")),
    ET.PERMANENT: NormalPermanentAlert(_("locationd Permanent Error")),
  },
  ...
  EventName.paramsdTemporaryError: {
    ET.NO_ENTRY: NoEntryAlert(_("paramsd Temporary Error")),
    ET.SOFT_DISABLE: soft_disable_alert(_("paramsd Temporary Error")),
  },

  EventName.paramsdPermanentError: {
    ET.NO_ENTRY: NoEntryAlert(_("paramsd Permanent Error")),
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert(_("paramsd Permanent Error")),
    ET.PERMANENT: NormalPermanentAlert(_("paramsd Permanent Error")),
  },

  EventName.speedLimitActive: {
    ET.WARNING: Alert(
      _("Set speed changed to match posted speed limit"),
      "",
      AlertStatus.normal, AlertSize.small,
  ...
  EventName.spAutoBrakeHold: {
    ET.PERMANENT: Alert(
      _("sunnypilot Brake Hold Active"),
      "",
      AlertStatus.normal, AlertSize.small,
  ...
  EventName.noGps: {
    ET.PERMANENT: Alert(
      ...
      _("Ensure device has a clear view of the sky"),
      AlertStatus.normal, AlertSize.small,
      Priority.LOWER, VisualAlert.none, AudibleAlert.none, .2, creation_delay=600.)
  },

  EventName.soundsUnavailable: {
    ET.PERMANENT: NormalPermanentAlert(_("Speaker not found"), "Reboot your Device"),
  ...
  EventName.espActive: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert(_("Electronic Stability Control Active")),
    ET.NO_ENTRY: NoEntryAlert(_("Electronic Stability Control Active")),
  },
