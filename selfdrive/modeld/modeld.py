...
def main(demo=False):
  ...
  # messaging
  extended_svs = ["lateralPlanDEPRECATED", "lateralPlanSPDEPRECATED", "controlsStateSP"]
  ...
  while True:
    ...
    if hasattr(sm["controlsStateSP"], "dynamicSteerActuatorDelay"):
      steer_delay = sm["controlsStateSP"].dynamicSteerActuatorDelay + .2
    else:
      steer_delay = CP.steerActuatorDelay + .2
