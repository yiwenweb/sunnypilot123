...
cdef class CANParser:
  ...
  def __init__(self, dbc_name, messages, bus=0, ignore_checksum=False, ignore_counter=False):
    ...
    self.can = new cpp_CANParser(bus, dbc_name, message_v, ignore_checksum, ignore_counter)
    self.update_strings([])
